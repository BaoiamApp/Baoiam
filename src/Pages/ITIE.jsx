    ...
    <div>
      ...
      <div className="flex flex-col md:flex-row items-center justify-center  bg-white p-6 mx-10">
        ...
        <div className=" md:w-1/2 text-center md:text-left">
          <h1 className="animes10 text-3xl md:text-5xl font-bold text-gray-800">
            Interns <span className="text-orange-500">TEACH</span> Interns{" "}
            <span className="text-blue-900">EARN</span>
          </h1>
          <h2 className="animes10 text-2xl md:text-3xl font-semibold text-gray-700 mt-4">
            ITIE Revolutionizes Internships
          </h2>
          <p className="animes10 text-gray-600 mt-6">
          ...
          <button
            className="animes10 mt-8 bg-gradient-to-r from-orange-400 to-orange-600 text-white py-2 px-6 rounded-full text-lg"
        ...
        {/* Image Section */}
        <div className="anime-img5 md:w-1/2 mt-8 md:mt-0 flex justify-center">
          <img
            src={img2}
            alt="Person pointing"
      ...
      {/* Program Overview */}
      <div className="anime-d10 mx-auto p-6 bg-white">
        <div className="flex flex-col md:flex-row items-center justify-between">
          <div className="animes12 w-full md:w-2/3 mb-4 md:ml-20 md:mb-0">
          ...
          <div className="anime-img6 w-full  hidden md:block">
      ...
      {/* Course Highlight */}
      <div className="anime-course max-w-5xl mx-5 md:mx-auto p-4 bg-white shadow-md rounded-2xl border-2 mt-16 mb-20 hover:scale-110 hover:shadow-2xl">
      ...
      <div className="anime-coursed max-w-6xl mx-auto p-6 bg-white">
        <h2 className="animes14 text-4xl md:text-5xl font-bold text-center mb-8 text-blue-900">
          Our <span className="text-orange-500">Courses</span>
        </h2>
        <div className="animes14 flex justify-center space-x-4 mb-8">
        ...
        <div className="animes14 grid grid-cols-1 md:grid-cols-3 gap-10">
          {courses.map((course, index) => (
            <div
              key={index}
              className="bg-white hover:shadow-2xl hover:border-2 hover:scale-105 overflow-hidden"
            >
              <img
                src={img1}
                alt={course.title}
      ...
      <div className="anime-coursed1">
        <h1 className="animes15 text-3xl md:text-5xl text-center font-semibold my-8 md:my-14 text-orange-600">
          Our <span className="text-blue-950">Testimonials</span>
        </h1>

        <div className="animes15 relative w-full px-4 md:px-10 pb-10 md:pb-20">
          <Swiper
            navigation={{
      ...
      <div className="anime-coursed2 flex flex-col items-center justify-center bg-orange-100 m-3 md:m-10 py-5 md:py-20 px-5 ">
        ...
        <div className="mt-6 flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-10">
          <div className="bg-white p-4 md:p-6 rounded-3xl shadow-2xl text-center border-2 border-orange-600 w-full md:w-auto">
            <h2 className="text-base md:text-lg font-semibold text-indigo-900">
              BUY 2 COURSES & GET MORE
            </h2>
            <p className="mt-4 text-3xl md:text-4xl font-extrabold text-orange-500">
              15%
            </p>
