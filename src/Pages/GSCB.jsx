...
import { GSCP, Impact, Trust, Value } from '../assets/assets'
        ...
        <div className='overflow-x-hidden'>
            <div className='w-[100vw] h-full pb-20'>
                <div className='h-[70vh] w-full relative overflow-hidden'>
                    <img src={GSCP} className="w-full h-full object-cover" alt="" />
                ...
                <div className='grid grid-cols-3 gap-8 w-full h-full mt-24 px-24'>
                    {section2.map((info, index) => {
                        return <div key={index} className='group flex flex-col gap-8 relative'>
                            <img className='w-full h-[32rem] object-cover' src={info.img} alt="" />
