...
const testimonials = [
    {
        ...
        name: "Preet Rajput",
        title: "Entrepreneur",
        content: "Started training at BAOIAM and got placed as a Entrepreneur with a package of 14 LPA. I would like to show my heartly gratitude to BAOIAM and its trainers for helping me out in building me career.",
    },
    {
        img: dummy1,
        name: "Lavanya Singh",
        title: "Entrepreneur",
        content: "I started my training at BAOIAM. With all the essential training and knowledge from my mentors, I landed a job for 12 LPA. Cannot thank enough for all the time and energy that BAOIAM and its mentors has invested in me.",
    },
    {
        img: dummy1,
        name: "Trisha Jain",
        ...
        <div>
            ...
            <div className="relative h-auto md:h-screen   mx-10">
                ...
                <div className="relative z-10 flex flex-col justify-center items-center md:items-end px-4 md:px-10 h-full ">
                    <div className="max-w-xl  text-center md:text-center border-2  border-orange-500 sm:border-none  rounded-lg">
                        <h1 className="text-3xl md:text-6xl font-bold text-orange-600">ENTREPRENEURSHIP</h1>
                        <h2 className="text-2xl md:text-4xl font-bold text-black">Course</h2>
                        <p className="mt-4 pb-5 sm:text-lg md:text-2xl text-gray-800 ">
                            Welcome to <strong>BAOIAM</strong>, the premier learning platform exclusively for women entrepreneurs! Ignite your entrepreneurial spirit and embark on your journey to success. As a launchpad for aspiring entrepreneurs, we empower you to learn, innovate, and achieve success.
                        </p>
                    </div>
                </div>
            </div>
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-between">
                        ...
                        <div className="w-full md:w-1/2 lg:w-1/2 mb-4 md:mb-0">
                            <div className="relative">
                                <img src={img2} alt="Person" className="rounded-2xl w-full object-cover" />
                            </div>
                        </div>
                        ...
                        <div className="w-full md:w-1/2 lg:w-1/2 md:ml-10">
                            <p className="text-lg text-justify md:text-xl font-light mt-4">
                                Our Entrepreneurship Courses are formulated in a way that can be easily studied and comprehended. We offer a plethora of courses that are skill-centric and are purely based on practical applications. Students can learn new skills or even hone their existing skills. This gives them a chance to build a strong skillset that can propel them to a new level in their professional lives.
                            </p>
            ...
            <div className="py-16">
                <div className="max-w-7xl mx-auto px-4 text-center">
                    <h2 className="text-4xl md:text-5xl font-bold text-black mb-8">
                        <span className="text-orange-500">Importance</span> and Opportunities
                    </h2>
                    <div className="flex flex-col md:flex-row justify-center space-y-8  md:space-y-0 md:space-x-6 mt-16">
                        {cards.map((card, index) => (
                            ...
                            >
                                <div>
                                    <h3 className=" text-center text-3xl font-bold text-orange-500 mb-4">{card.number}</h3>
                                    <h4 className="text-xl font-semibold text-blue-900 mb-4">{card.title}</h4>
                                    <p className="text-gray-700 mt-14 leading-relaxed text-justify ">{card.description}</p>
                                </div>
                            </div>
                        ))}
                    </div>
            ...
            <div className="bg-white p-6 md:p-10">
                ...
                <div className="mx-auto max-w-7xl px-4 md:px-6">
                    ...
                    <div className="text-center my-10">
                        <h1 className="text-3xl md:text-5xl font-bold text-orange-500">
                            Women <span className="text-blue-900"> Entrepreneurship Program</span>
                        </h1>
                    </div>
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-between">
                        ...
                        <div className="w-full md:w-1/2 lg:w-1/2 md:ml-10">
                            <p className="text-center md:text-left md:leading-relaxed text-xl mt-4">
                                Our Women Entrepreneurship Program aims to support and empower women in starting and growing their businesses. This program is specially pieced together by our experts to guide our women entrepreneurs and to teach them to build their strong business empires. It typically includes mentorship, training, and resources to enhance skills, foster networking, and overcome challenges women may face in the business world. The goal is to promote economic independence and gender equality.
                            </p>
                        ...
                        <div className="w-full md:w-1/2 lg:w-1/2 mb-4 md:mb-0">
                            <div className="relative">
                                <img src={img3} alt="Person" className="rounded-2xl w-full object-cover" />
                            </div>
                        </div>
