...
const HireFromUs = () => {
  ...
  return (
    <div className="dark:text-white dark:bg-black space-y-16">
      <section
      ...
      >
        <div className="absolute inset-0 bg-gradient-to-r from-black via-transparent to-black opacity-90 flex flex-col justify-center items-center">
          <h1 className="text-4xl md:text-7xl font-extrabold text-white text-center mb-6">
            ...
            <span className="text-amber-600">Baoiam</span>
          </h1>
      ...
      <section
        id="why-choose-us"
        className="relative px-8 lg:px-20 py-16 dark:bg-black bg-gradient-to-r from-white to-indigo-50 text-indigo-500 overflow-hidden"
      >
        <h2 className="text-4xl sm:text-5xl font-extrabold dark:text-white text-center mb-12 sm:mb-16 relative z-10 text-gray-800">
          Why Choose Us?
        </h2>

        <div className="absolute dark:bg-black inset-0 overflow-hidden">
          <svg
        ...
        <div className="relative z-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-12">
          {[
            ...
            <div
              key={index}
              className={`relative bg-white p-6 sm:p-8 rounded-xl shadow-lg flex flex-col items-center text-center transition-transform transform hover:scale-105 ${
                index % 2 === 0 ? "mt-12" : "mb-12"
              }`}
            >
              <div className="mb-4 sm:mb-6 text-amber-500">{feature.icon}</div>
              <h3 className="text-lg sm:text-2xl font-bold mb-2 text-indigo-700">
                {feature.title}
              </h3>
      ...
      <section className="relative py-16 px-8 lg:px-20">
        ...
        <div className="text-center mb-12 relative z-10">
          <h2 className="text-4xl md:text-6xl dark:text-white font-bold text-gray-800 mb-4">
            Discover Our <span className="text-indigo-600">Profiles</span>
          </h2>
          <p className="text-lg md:text-xl dark:text-slate-300 text-gray-600">
        ...
        <div className="text-center mb-12 relative z-10">
          <h2 className="text-3xl dark:text-slate-300 font-bold text-gray-800 mb-8">
            Our Expertise
          </h2>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-10 justify-center relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:w-1/2">
            {[
              ...
              <div
                key={index}
                className="bg-white p-8 rounded-2xl hover:bg-indigo-50 shadow-lg hover:shadow-xl hover:scale-105 transition-transform duration-300 flex items-center space-x-6"
              >
          ...
          <div className="lg:w-1/2">
            <h3 className="text-2xl font-bold dark:text-white text-gray-800 mb-6">
              Other Profiles
            </h3>
      ...
      <section className="dark:bg-black py-16 px-8 lg:px-32">
      ...
      <section
        id="contact-form"
        className="relative dark:bg-black py-16 px-4 md:px-8 lg:px-16 bg-gradient-to-br from-indigo-50 via-white to-indigo-100"
      >
