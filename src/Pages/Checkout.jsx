        ...
        <div className="w-full h-fit flex items-center flex-col md:flex-row justify-between gap-4 bg-white px-8 py-4 rounded-lg">
          ...
          <div className="w-full md:w-[75%] h-full">
            ...
            <p className="text-sm mt-2">
              Welcome to the Art and Craft Exploration course, a vibrant and
              imaginative journey designed for students. You will dive into
            </p>
            <p className="text-sm mt-4 flex items-center gap-2">
              <span>25 Lessons</span>•<span>52 Hours</span>
            </p>
          </div>
        </div>
        ...
        <div className="w-full h-fit flex flex-col items-center justify-center gap-4 mt-4 py-4 bg-white rounded-lg">
          <div className="grid grid-cols-1 gap-y-4 md:grid-cols-3">
            <div className="flex text-nowrap tracking-tight justify-start text-sm xl:text-lg items-center gap-2">
              <GoProjectRoadmap className="bg-gradient-to-r from-indigo-800 to-indigo-500 text-white text-4xl xl:text-6xl rounded-full p-2 xl:p-4" />{" "}
              Interview Training
            </div>
            <div className="flex text-nowrap tracking-tight justify-start text-sm xl:text-lg items-center gap-2">
              <MdOutlineClass className="bg-gradient-to-r from-indigo-800 to-indigo-500 text-white text-4xl xl:text-6xl rounded-full p-2 xl:p-4" />{" "}
              Placement Assistance
            </div>
            <div className="flex text-nowrap tracking-tight justify-start text-sm xl:text-lg items-center gap-2">
              <PiCertificate className="bg-gradient-to-r from-indigo-800 to-indigo-500 text-white text-4xl xl:text-6xl rounded-full p-2 xl:p-4" />{" "}
          ...
          <p>
            and{" "}
            <span className="bg-gradient-to-r from-pink-500  to-violet-600 bg-clip-text text-transparent font-medium">
              Many More Benefits!
            </span>
          </p>
        </div>
