    ...
    <>
      ...
      <div className="pl-10 dark:bg-black dark:text-white p-4 bg-white text-black">
        ...
        <div className="container flex pt-10 items-center justify-center p-6">
          <div className="flex flex-col md:flex-row items-center mx-auto w-full">
            <div className="w-1/2 text-center lg:text-left">
              ...
              <p className="text-base sm:text-lg md:text-xl mb-6">
                ...
                your academic goals. Whether you're looking to improve your
                skills or start a new learning journey, we have something for
                everyone.
              </p>
              <a
                href="#courses"
                className="px-6 py-2 text-xl bg-gradient-to-r from-indigo-800 to-indigo-500 rounded-xl  text-white hover:bg-gradient-to-l transition-all ease-in-out duration-300"
              >
                Explore Courses
              </a>
            </div>
