  ...
  const data = [
    {
      ...
      data: (
        <div>
          ...
          <p>
            Learn about how Ed-Tech enhances critical thinking abilities and
            approaches and possibilities in education technology. Understand the
            role of critical thinking in contemporary learners. This blog
            evaluates how Ed-Tech changes the method of students’ critical
            thinking skills and the role it plays in the future.
          </p>
        </div>
      ),
    },
    {
      ...
      data: (
        <div>
          <p>
            Among all practical skills relevant to the students of the current
            academic year, critical thinking skills have become significant in
            the context of globalization and advancement in education. Critical
            thinking, which entails assessing and solving issues, is vital When
            the global environment becomes more challenging. What is critical
            thinking? Essentially, critical thinking means-
          </p>
          <li>
            <span className="font-bold">Logical and unbiased thinking:</span>
            <span>
              The abilities of logical and unbiased thinking concerning logic
              and its connections and relations.
            </span>
          </li>
          <li>
            <span className="font-bold">
              Dealing with life tasks and problems:{" "}
            </span>
            <span>
              {" "}
              This skill is essential for academic success and dealing with life
              tasks and problems.
            </span>
          </li>
          <li>
            <span className="font-bold">Ability to think critically: </span>
            <span>
              {" "}
              The role of critical thinking in education is crucial. It enhances
              the ability of students to think critically by challenging
              assumptions, making alternatives, and making sound decisions.
            </span>
          </li>
        </div>
      ),
    },
    {
      heading: (
        <div>
          <h1 className="text-[1.6rem]">
            The Role of Ed-Tech in Enhancing Critical Thinking Skills
          </h1>
          <h2 className="text-[1.4rem] mt-4">
      ...
      data: (
        <div>
          <li>
            Ed-Tech is essential in enhancing the customisation or
            individualisation of learning environment delivery.{" "}
          </li>
          <li>
            <li>
              Ed-Tech is essential in enhancing the customisation or
          ...
          <li>
            Such an approach allows students to solve questions that stimulate
            their thinking capacities without feeling compelled to read through
            voluminous materials.
          </li>
          <li>
            Incorporating Artificial Intelligence (AI) in technology companies
            enhances education by offering students formative feedback during
            problem-solving.
          </li>
        </div>
      ),
    ...
    {
      heading: (
        <p className="text-[1.6rem]">Interactive Learning Environments</p>
      ),

      data: (
        <div>
          <img
            className="h-[20rem] w-[100%] mb-5 object-contain"
            src={critical}
          />
          <p>
            The use of multiple features like basic simulator games and virtual
            experiments usually entails the use of critical thinking skills by
            the students in real-time. These educational tools require learners
            to engage and think critically by solving particular problems,
            making decisions, and evaluating the consequences. For example, in
            the context of VR, study real-world conditions that require
            students’ critical thinking when facing obstacles, while managing a
            virtual company or conducting and analysing a virtual experiment.
          </p>
        </div>
      ),
    },
    {
      heading: (
        <p className="text-[1.6rem]">Collaboration and Communication Tools</p>
      ),
    ...
    {
      heading: (
        <p className="text-[1.6rem]">Problem-Solving Courses and Programs</p>
      ),
    ...
    },
    {
      heading: (
        <div>
          <h1 className="font-bold my-[2rem] text-[1.9rem]">
            Strategies for Integrating Ed-Tech into Critical Thinking
            Development
          </h1>
          <h2 className="font-bold text-[1.6rem]">
            Incorporating Ed-Tech into Daily Lessons:
          </h2>
        </div>
      ),
    ...
    {
      heading: (
        <p className="text-[1.6rem]"> Encouraging Collaborative Learning</p>
      ),
    ...
    {
      heading: (
        <p className="text-[1.6rem]">Providing Access to various Resources</p>
      ),
    ...
    {
      heading: (
        <p className="text-[1.6rem]">Leveraging Data to Track Progress</p>
      ),
    ...
    },
    {
      heading: (
        <p className="text-[1.9rem]">
          Future Prospects: The Evolution of Ed-Tech in Critical Thinking
          Development
        </p>
      ),
    ...
    },
    {
      heading: (
        <div>
          <h1 className="font-bold text-[1.9rem]">Conclusion</h1>
    ...
    <>
      ...
      <div className="w-[80%] lg:flex lg:flex-row  flex-col gap-[2rem] mx-[10%] mt-[10%]">
        ...
        <div className="w-[100%] lg:w-[30%]">
          <div className="w-[100%] rounded lg:h-auto h-[45%] text-center dark:border-white dark:border-[1px] shadow-xl shadow-[#00000081] dark:text-black flex flex-col gap-2 items-center">
            <h2 className="text-[22px] font-bold text-center dark:text-white">
              Categories
            </h2>
            <div className="text-[20px] mx-8  bg-slate-300 p-3  rounded cursor-pointer transition-all dark:border-[1px] border-black border-[1px]">
              Product Development
            </div>
            <div className="text-[20px] mx-8  bg-slate-300 p-3 rounded  cursor-pointer transition-all dark:border-[1px] border-black border-[1px]">
              Entrepreneurship
            ...
            <div className="text-[20px] mx-8  bg-slate-300 p-3 mb-5 rounded  cursor-pointer transition-all dark:border-[1px] border-black border-[1px]">
