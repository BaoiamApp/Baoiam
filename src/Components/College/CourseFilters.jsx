  ...
  return (
    <div className="relative h-11/12 ">
      ...
      <button
        ...
        className="absolute  flex gap-0 items-center left-4 z-20 p-1 pl-4 h-max shadow-md bg-white  rounded-lg border-2"
      >
        <div>Filters</div> 
        {/* <FaFilter size={16} /> */}
      ...
      {/* Sidebar */}
      <div
        className={`fixed inset-y-0 left-0 z-30 rounded-r-md w-64 p-4 max-h-[80%] my-auto bg-white shadow-lg transform transition-transform ${
      ...
      >
        ...
        <button
          onClick={toggleSidebar}
          className="absolute flex items-center top-4 right-4 z-20 p-2 aspect-square bg-slate-200  rounded-full "
        >
          {/* <FaFilter size={20} /> */}
