...
const CoursesMain = () => {
  const courses = [
    { name: 'UI/UX Design', progress: 50, image: 'https://miro.medium.com/v2/resize:fit:720/1*aBQrwweY6-qFVWeizUrTnQ.png' },
    { name: 'Web Developement', progress: 100, image: 'https://miro.medium.com/v2/resize:fit:720/1*aBQrwweY6-qFVWeizUrTnQ.png' },
    { name: 'Data Analysis', progress: 10, image: 'https://miro.medium.com/v2/resize:fit:720/1*aBQrwweY6-qFVWeizUrTnQ.png' }
  ];
  ...
  return (
    <div className="w-full backdrop-filter bg-indigo-100 shadow-border backdrop-blur-lg dark:text-white dark:border dark:border-white h-fit mx-auto p-4 rounded-lg shadow-md">
      <h2 className="text-3xl text-black font-bold mb-5 text-center">Courses</h2>
