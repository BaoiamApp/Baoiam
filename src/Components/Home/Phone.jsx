...
const Phone = () => {
    ...
    return (
        <div className='flex bg-amber-50 dark:bg-black dark:text-white items-center gap-8 lg:gap-12 justify-center flex-col md:flex-row mt-12 py-12 px-8 lg:px-20'>
            ...
            <div className=''>
                <p className='text-3xl lg:text-5xl font-semibold mb-2 lg:mb-4'>Enroll in Course!</p>
                <p className='text-sm lg:text-base'>Unlock your potential for success with our course.
                </p>

                <form className='flex flex-col gap-4 mt-4 lg:mt-8'>
                    <div className='flex items-center gap-4'>
                        <div onClick={() => setInputValue('Email')} className='flex items-center gap-2 text-sm lg:text-lg'>
                            <input type="radio" name='link' id="email" className='lg:size-4' defaultChecked />
                            <label htmlFor="email">Email</label>
                        </div>
                        <div onClick={() => setInputValue('Phone')} className='flex items-center gap-2 text-sm lg:text-lg'>
                            <input type="radio" name='link' id="phone" className='lg:size-4' />
