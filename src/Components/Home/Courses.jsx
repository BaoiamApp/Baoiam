...
const Courses = () => {
  return (
    <div className='w-[100%] dark:bg-[#080529] bg-gray-400 '>
      ...
      <p className='text-center font-bold text-white text-[1.5rem] lg:text-[2rem] pt-[1rem]'>Explore Free Online Courses</p>
      ...
      '>
        ...
        <div className='w-[70vw] mx-auto sm:w-[40vw] lg:w-[16vw] rounded-2xl p-[5%]  border-2 border-gray-200 bg-white text-center'>
