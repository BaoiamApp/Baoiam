  ...
  return (
    <div className="bg-white flex flex-col pt-5 md:flex-row h-[100vh] md:h-[80vh] md:py-12 px-6 lg:px-16">
      ...
      <div className="w-full flex gap-y-3 flex-col lg:w-1/2 text-center lg:text-left">
        ...
        <h1 className="text-black text-3xl sm:text-4xl lg:text-5xl font-bold">
          {" "}
          With <span className="text-orange-500">Technology</span>
        </h1>
        <p className="mt-4 text-lg text-black sm:text-xl lg:text-2xl">
          Join thousands of learners from around the world who are mastering new
          skills, advancing their careers, and exploring new opportunities.
        </p>
        <div className="mt-8 flex justify-center lg:justify-start space-x-4">
          ...
          <button
            ...
            className="bg-trasparent border border-black text-black text-xl px-6 py-3 rounded-lg font-semibold hover:bg-blue-500 hover:text-white hover:border-white"
          >
            Get Started
          </button>
        </div>
