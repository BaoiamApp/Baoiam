...
const Hero = () => {
  ...
  return (
    <div className="bg-white dark:bg-black dark:text-white flex flex-col-reverse md:flex-row px-8 lg:px-20 lg:-mt-16 items-center">
      ...
      <div className="w-full flex md:pl-5 gap-y-1 pb-10 md:pb-0 flex-col lg:w-1/2 text-center md:text-left">
        ...
        <p className="mt-5 dark:text-white text-black">
          Experience personalized learning designed to equip you with the skills
          to excel. Unlock new opportunities, grow your expertise, and take your
        ...
        <div className="mt-6 flex justify-center md:justify-normal lg:justify-start space-x-4">
          ...
          >
            ...
            <span class="relative text-sm lg:text-base">
              Discover Your Path
            </span>
          </button>
        </div>
