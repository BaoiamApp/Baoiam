      ...
      >
        ...
        <div>
          <div className="flex items-center gap-2 md:gap-4 text-black dark:text-white">
            ...
            {/* <Link to={"/gcep"} class="relative inline-block text-lg group">
              <span class="relative z-10 block px-5 py-2 overflow-hidden font-medium leading-tight text-gray-800 transition-colors duration-300 ease-out border-2 border-gray-900 rounded-lg group-hover:text-white">
                ...
                <span class="relative">GCEP</span>
              </span>
              <span class="absolute bottom-0 right-0 w-full h-12 -mb-1 -mr-1 transition-all duration-200 ease-linear bg-gray-900 rounded-lg group-hover:mb-0 group-hover:mr-0" data-rounded="rounded-lg"></span>
            </Link> */}

            {/* <Link to={"/gcep"} class="relative inline-flex items-center justify-start px-6 py-2 overflow-hidden font-medium transition-all border border-indigo-500 bg-white rounded-lg hover:bg-white group">
              ...
              <span class="relative w-full text-left text-sm text-black transition-colors duration-300 ease-in-out group-hover:text-white">GCEP</span>
            </Link> */}
