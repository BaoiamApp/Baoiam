...
const Navbar = () => {
  ...
  return (
    ...
    <div><img className='h-[4rem] w-[8rem]' src={img1}/></div>



    <div className='hidden lg:block lg:mt-6 xl:mt-7'>
        <ul className='flex '>
    ...
    <div className='px-3 w-[20%] h-[3rem] mt-4 border-2 py-0.9 lg:pt-0.1 hidden lg:px-3 lg:w-[29%] xl:w-[22vw] lg:rounded-lg lg:border-gray-400 md:flex lg:justify-between lg:mb-2 xl:flex sm:py-2 sm:flex sm:w-[50%] rounded-lg border-gray-400'>

      <input className='w-[14rem] h-[2rem] lg:text-[1rem] outline:none xl:w-[16rem]  sm:text-[2.3vw] sm:w-[85%] mr-2  ' type="text" placeholder='Search for your favorite course'></input>
    ...
    <div className='bg-orange-400 xl:px-[2rem] sm:mb-1 xl:w-[8%]  font-bold lg:block lg:p-1 lg:px-3 py-2 pl-3 xl:py-1 lg:pl-5 lg:mr-1 w-[9%] md:pl-5 md:pt-2 h-[4%] lg:w-[7%]  mt-5  px-14 rounded-lg text-white'><button className='sm:pt-1 md:mb-1 lg:text-center'>GCEP</button></div>

    <div className='flex '>

        <div className='border-2 xl:flex hidden lg:hidden px-3 xl:pt-0 xl:h-10 xl:mt-5 mr-[1rem] border-violet-700 rounded-lg mb-1 text-violet-700'>
          <button className='pr-2 '>Login</button>
        <FaRegUser className='mt-3'/>
        </div>
        <div className='bg-violet-700 hidden xl:block xl:h-10 xl:mt-5 xl:pt-1 lg:hidden text-white font-semibold border-2 border-blue-700 mb-1 rounded-lg px-3 '><button>Sign Up</button></div>
    </div>
    
    <div>
    <div className="absolute lg:block top-[2.5rem] md:mt-5 lg:absolute lg:right-4 lg:top-2 xl:hidden sm:top-[1.4rem] sm:mt-3.5 sm:ml-4 right-[2rem]"><FaBars className='text-[2rem] ' onClick={()=>setShowmenu(!showmenu)} />
    </div>
