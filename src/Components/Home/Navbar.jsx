    ...
    <>
      <div className="flex items-center justify-between px-4 py-2 bg-white dark:bg-black relative">
        ...
        <div className="hidden lg:flex items-center justify-between mt-4">
          ...
          <Link to={"/pap"} className="mx-4">
            PAP
          </Link>
          <Link to={"/itie"} className="mx-4">
            ITIE
          </Link>
        ...
        <div className="flex items-center gap-4 text-white mt-2">
          ...
          <Link
            to={"/gscp"}
            className="relative px-6 py-2 z-10 ml-2 overflow-hidden font-medium text-indigo-500 bg-gray-100 border border-gray-100 rounded-full hidden md:block shadow-inner group"
          >
          ...
          <span
            onClick={darkTheme}
            className="text-[1.7rem] z-10 cursor-pointer hidden lg:block"
          >
            {isDark ? (
              <BsMoonStars className="text-white" />
            ) : (
