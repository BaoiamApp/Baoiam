  ...
  return (
    <>
      <div className='flex justify-evenly bg-white p-[2rem]'>
        ...
        <div><img className='h-[3.5rem] w-[8rem]' src={img1} /></div>
        ...
        <div className='hidden lg:block'>
          <ul className='flex '>
            ...
            <div className='flex flex-col'>
              <li className='mx-4 cursor-pointer' onClick={() => setShow(!show)}>Courses</li>
...

          {
            showmenu && <div className='absolute w-[9rem] right-[0.5rem] mt-[5.5rem] bg-white'>
              <ul className='flex flex-col  '>
                ...
                {/* {show ? <FontAwesomeIcon className='ml-1' icon={faCaretUp} /> : <FontAwesomeIcon className='ml-1' icon={faCaretDown} />} */}
                <div className='flex flex-col'>
                  <li className='mx-5 cursor-pointer my-1 lg:hidden' onClick={() => setShow(!show)}>Courses 
                  </li>
                ...
                <button className='ml-2'>Sign Up</button></li>
                <li className='mx-3 my-1'>
                  {/* <FontAwesomeIcon icon={faUser} /> */}
                <button className='ml-2'>Login</button></li>
              </ul>
