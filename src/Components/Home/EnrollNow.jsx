...
const EnrollNow = () => {
  ...
  return (
    <div>
      ...
      <button type="button"
        onClick={togglePopup} className="relative w-fit rounded-lg px-5 py-2 overflow-hidden group bg-green-500 hover:bg-gradient-to-r hover:from-green-500 hover:to-green-400 text-white hover:ring-2 hover:ring-offset-2 hover:ring-green-400 transition-all ease-out duration-300">
