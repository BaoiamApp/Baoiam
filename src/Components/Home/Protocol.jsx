...
const Protocol = () => {
  return (
    ...
    <div className='mt-[4rem]'><h1 className='text-[2rem] my-2 text-center font-bold'>Virtues and protocols <span className='underline text-amber-500'>BAOIAM</span> works on</h1></div>
   ...
   <div className='flex-col w-[100%] lg:flex lg:justify-evenly lg:flex-row lg:px-[1rem] lg:w-[100%]'>
     ...
     <div className='w-[90%] lg:w-[30%] p-[2rem]  flex-col my-[0.5rem]'>
           <div className=' flex justify-center pl-[2.5]'><MdOutlineSupportAgent className='text-[8rem] pt-5 text-indigo-500'/></div>
     ...
     <div className='w-[90%] p-[2rem] lg:w-[30%]  flex-col my-[0.5rem]'>
           <div className=' flex justify-center pl-[0rem]'><FaChalkboardTeacher className='text-[7rem] pt-5 text-indigo-500'/></div>
      ...
      <div className='w-[90%] p-[2rem] lg:w-[30%]  flex-col my-[0.5rem]'>
           <div className='flex justify-center pl-[2rem]'><FaTabletScreenButton className='text-[7rem] pt-6  text-indigo-500'/></div>
