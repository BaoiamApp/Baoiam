  ...
  return (
    <>
      <div className="mt-[4rem]">
        <h1 className="animes5 text-[2rem] my-2 text-center font-bold">
          Virtues and protocols <span className="text-indigo-600">BAOIAM</span>{" "}
          works on
        </h1>
      </div>
      ...
      <div className="flex-col w-[100%] lg:flex lg:justify-evenly lg:flex-row lg:px-[1rem] lg:w-[100%]">
        <div className="w-[90%] lg:w-[30%] p-[2rem]  flex-col my-[0.5rem]">
          <div className="anime-img4 flex justify-center pl-[2.5]">
            <MdOutlineSupportAgent className="text-[8rem] pt-5 text-indigo-500" />
          </div>
          <div className=" text-center p-2.5 lg:p-0">
            {" "}
            <h2 className="anime-h2 font-bold sm:text-[1.2rem] lg:text-[1.1rem]">
              FULL-TIME SUPPORT
            </h2>{" "}
            <p className="anime-p1 sm:text-[1.1rem] lg:text-[1rem]">
        ...
        <div className="w-[90%] p-[2rem] lg:w-[30%]  flex-col my-[0.5rem]">
          <div className="anime-img4 flex justify-center pl-[0rem]">
            <FaChalkboardTeacher className="text-[7rem] pt-5 text-indigo-500" />
          </div>
          <div className=" text-center p-3">
            {" "}
            <h2 className="anime-h2 font-bold lg:text-[1.1rem] sm:text-[1.2rem]">
        ...
        <div className="w-[90%] p-[2rem] lg:w-[30%]  flex-col my-[0.5rem]">
          <div className="anime-img4 flex justify-center pl-[2rem]">
