...
const Course = () => {
  ...
  const { id } = useParams();
  const course = SchoolCourse.find((cate) =>
    ...
    <div>
      ...
      <div className='flex items-center justify-between px-24 my-12'>
        <div className='flex flex-col gap-4'>
          ...
          <button
            onClick={handleEnrollnavigate}
            className='pl-4 pr-6 py-2 border border-orange-400 text-orange-400 font-semibold rounded-r-full w-fit flex items-center gap-4 group hover:bg-orange-400 hover:text-white'
          >
            Enroll Now{" "}
            <FaArrowRightLong size={22} className='group-hover:animate-pulse' />{" "}
          </button>
        </div>
      ...
      <div className='px-24 my-12 py-12 text-white bg-gradient-to-r from-orange-400 to-orange-600'>
        <h4 className='text-3xl font-semibold mb-4'>
          Course <span className='border-b'>Overview</span>
        </h4>
      ...
      <div className='w-full px-24 my-20 h-full '>
        <h4 className='text-3xl font-semibold text-neutral-600 mb-4'>
          Course{" "}
      ...
      <div className='py-8 px-24 w-full h-full text-white bg-gradient-to-r from-orange-400 to-orange-600'>
        <h4 className='text-3xl font-semibold text-white mb-8'>
          Course <span className='border-b'>Highlights</span>
        </h4>
        ...
        <div className='flex items-center flex-wrap gap-x-6 gap-y-4 text-black'>
          {subCourse.highlights.map((h, i) => {
            return (
              <div
                key={i}
                className='bg-white group hover:scale-105 hover:shadow-2xl px-4 py-8 h-44 rounded-xl flex flex-col gap-4 w-64'
              >
                <span className='text-3xl group-hover:text-orange-600 group-hover:animate-bounce transition-all ease-in-out'>
                      ...
                      <button
                        className={`block rounded-lg ${
                          p.name === "Premium"
                            ...
                            : "bg-gray-300"
                        } px-8 py-3 text-center text-sm font-semibold text-gray-500 outline-none ring-indigo-300 transition duration-100 hover:bg-gray-300 focus-visible:ring active:text-gray-700 md:text-base`}
                      >
                        Buy Now
                      </button>
                    </div>
      ...
      <div className='flex items-center justify-around px-24 my-32'>
        <div className='border border-orange-500 rounded-3xl px-6 py-4 shadow-xl w-[35rem]'>
          <p className='text-center font-semibold text-orange-500 text-xl mb-2'>
            Easy EMI
          </p>
      ...
      <div className='py-8 px-24 my-20 w-full h-full text-white bg-gradient-to-r from-orange-400 to-orange-600 text-center'>
        ...
        <div className='flex items-center gap-4 justify-center w-full mt-8'>
          <div className='bg-white w-80 rounded-3xl px-6 py-4 shadow-xl'>
            <p className='text-center font-semibold text-neutral-500 text-xl mb-2'>
              BUY 2 COURSES & GET
            </p>
