        ...
        <div className='flex flex-col lg:flex-row md:flex-row px-8 text-xl lg:px-36'>
            <div className='flex flex-row lg:flex-col md:flex-col items-center border border-indigo-500 p-6 md:items-start mt-4 rounded-3xl md:pl-6 gap-6 md:gap-4 md:h-[28rem]'>
                ...
                <div
                    ...
                    className={`flex items-start md:items-center w-full rounded-lg md:gap-3 hover:bg-indigo-500 hover:text-white p-2 cursor-pointer ${isTabActive === 'coursecard' ? 'bg-indigo-600 text-white' : 'border border-indigo-600'}`}>
                ...
                <div
                    ...
                    className="flex items-start md:items-center w-full rounded-lg md:gap-3 hover:bg-indigo-500 hover:text-white p-2 cursor-pointer border border-indigo-600">
