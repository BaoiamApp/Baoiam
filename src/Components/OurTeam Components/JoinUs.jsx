    ...
    return (
        <div className='tdiv5 t5 w-full h-52 md:h-80 my-6 relative '>
            ...
            <div className="flex absolute top-0 right-0 items-center gap-4 z-20 w-full h-full justify-center flex-col">
                <h1 className='t5 text-white text-xl max-w-[80%] text-center md:text-2xl lg:text-4xl font-serif'>you'll look better <span className='text-indigo-500 uppercase'>with us</span> </h1>
                <button className='t5 rounded-full gap-2 flex items-center px-6 py-2 justify-center font-medium text-white group bg-gradient-to-br from-purple-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-black dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800'>
                    <Link to={'/career'} className='relative transition-all ease-in duration-75 dark:bg-gray-900 group-hover:bg-opacity-0'> 
                    Join us
                    </Link>
                    <FaArrowRight />
                </button>
