...
const GSCPBottom = () => {
  ...
  return (
    <div className="relative text-center p-8 md:p-12 lg:p-[5.5vw] before:content-[''] before:absolute before:w-[50%] before:h-1 before:bg-gradient-to-r before:from-indigo-500 before:to-purple-600 before:top-0 before:left-1/2 before:transform before:-translate-x-1/2 after:content-[''] after:absolute after:w-[50%] after:h-1 after:bg-gradient-to-r after:from-indigo-500 after:to-purple-600 after:bottom-0 after:left-1/2 after:transform after:-translate-x-1/2">
