...
import perks from "../../assets/perks.jpg"
...
const [activeTab, setActiveTab] = useState("services");
 const renderContent = () => {
  ...
  return (
    <div>
      <div className="p-4 sm:p-6 mx-4 sm:mx-10 ">
        <div className="flex flex-col mb-5 sm:flex-row space-y-4 sm:space-y-0 sm:space-x-8 
       ">
          <button
            className={`text-xl sm:text-2xl font-bold ${activeTab === "services"
          ...
          <button
            className={`text-xl sm:text-2xl font-bold ${activeTab === "features"
                ? "border-b-4 border-indigo-600 text-indigo-600"
                : "text-blue-950"
              }`}
          ...
          <button
            className={`text-xl sm:text-2xl font-bold ${activeTab === "perks"
                ? "border-b-4 border-indigo-600 text-indigo-600"
                : "text-blue-950"
              }`}
          ...
          <button
            className={`text-xl sm:text-2xl font-bold ${activeTab === "reviews"
                ? "border-b-4 border-indigo-600 text-indigo-600"
                : "text-blue-950"
              }`}
