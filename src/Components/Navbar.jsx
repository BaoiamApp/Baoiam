...
const Navbar = () => {
  ...
  return (
    ...
    <div className='hidden lg:block'>
        <ul className='flex '>
            ...
            <div className='flex flex-col'>
              <li className='mx-4 cursor-pointer' onClick={()=>setShow(!show)}>Courses {show?<FaCaretUp/>:<FaCaretDown/>}</li>
    ...
    <div>
    <div className="absolute lg:block top-[2rem] xl:hidden sm:top-[2.2rem] right-[2rem]"><FaBars className='text-[2rem]' onClick={()=>setShowmenu(!showmenu)}/>
    </div>

    {
      showmenu && <div className='absolute w-[9rem] right-[0.5rem] mt-[5.5rem] bg-white'>
         <ul className='flex flex-col  '>
            ...
            <div className='flex flex-col'>
              <li className='mx-5 cursor-pointer my-1 lg:hidden' onClick={()=>setShow(!show)}>Courses {show?<FaCaretUp className='ml-1'/>:<FaCaretDown className='ml-1'/>}</li>
            ...
            <li className='mx-3 my-1'><FaRightToBracket/><button className='ml-2'>Sign Up</button></li>
            <li className='mx-3 my-1'><FaUser/><button className='ml-2'>Login</button></li>
        </ul>
