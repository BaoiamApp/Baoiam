...
const FaqItem = ({ question, answer }) => {
  ...
  return (
    <div className="border rounded-lg mx-5 shadow-lg text-gray-600 px-4 py-1 my-4 sm:px-6 lg:px-8">
      <button
        className="w-full text-left flex justify-between dark:text-slate-200 items-center py-2 sm:py-4 text-md sm:text-lg text-black font-bold hover:scale-105 dark:hover:text-indigo-500 hover:text-indigo-600"
  ...
  return (
    <div className="max-w-3xl mx-auto my-10 px-4 sm:px-6 lg:px-8">
      ...
      <div className="mt-10 text-center">
        <h1 className="text-xl sm:text-2xl font-bold dark:text-white text-gray-600 mb-4">
