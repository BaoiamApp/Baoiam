            ...
            <div className="text-center sm:text-left">
              ...
              <ul className="mt-4 space-y-4 text-sm">
                ...
                <li className="flex items-center gap-1.5 justify-center sm:justify-start">
                  ...
                  <span className="text-white">tutors@baoiam.com</span>
                </li>
                ...
                <li className="flex items-center gap-1.5 justify-center sm:justify-start">
                  ...
                  <span className="text-white">08069640635</span>
                </li>

                {/* Address */}
                <li className="flex items-start gap-1.5 justify-center sm:justify-start">
                  <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
