    ...
    <footer className="bg-indigo-600">
      <div className="mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8 lg:pt-24">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            <div className="flex justify-center text-teal-600 sm:justify-start h-24 w-56">
...
// {/* <div className="w-full pt-8 pb-4 dark:bg-black dark:text-white rounded-lg relative shadow-md bg-slate-200 text-white ">
...
//           <div className="flex items-center gap-3">
//             <a href="/terms-conditions" className="text-white hover:underline">
//               Terms & Conditions
//             </a>
