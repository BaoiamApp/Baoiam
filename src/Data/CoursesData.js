...
const school = [
  {
    id: 1,
    title: "Art and Craft",
    desc: `Welcome to the Art and Craft Exploration course, a vibrant and imaginative journey designed for students. You will dive into a world of creativity through hands-on projects and artistic experimentation. From mastering drawing and painting techniques to crafting unique textile and sculpture pieces, this course offers a diverse range of activities that will ignite your artistic passion and help you express yourself. With a focus on creativity, skill development, and personal expression, you will build confidence in your artistic abilities while exploring the endless possibilities of art and craft. Get ready to create, explore, and showcase your unique artistic talents!`,
    overview: [
  ...
  },
  {
    ...
    desc: `Welcome to the Public Speaking Mastery course, where students embark on an empowering journey to enhance their communication skills and build confidence. You will dive into the art of crafting compelling speeches, mastering effective delivery techniques, and engaging audiences with poise and clarity. Through interactive exercises, practice sessions, and constructive feedback, you'll learn how to present your ideas with impact and confidence. Whether you are preparing for a classroom presentation or a future career, this course will equip you with the essential skills to speak persuasively and connect with your audience effectively. Get ready to transform your public speaking abilities and discover the power of your voice!`,
    overview: [
...
const college = [
  {
    ...
    overview: [
      ...
      `Gain a deep understanding of every facet of Product Management, from identifying lucrative market opportunities to defining compelling product visions and strategies. Learn how to effectively prioritize features, harness the power of agile methodologies, and collaborate seamlessly with cross- functional teams throughout the prodüct development journey.`,
...
`,
    ...
    curriculum: [
      ...
      `Learning how to conducts market research, analyze trends, and identify customer needs
`,
...
`,
  ...
  },
  {
    ...
    desc: `Unlock your potential in Human Resource Management with our comprehensive course! Covering recruitment, employee relations, and organizational development, this program equips you with the essential skills to excel in HR roles. Navigate HR policies effortlessly and foster a positive workplace culture with confidence. Prepare for key roles in talent management and retention with practical insights and industry projects led by esteemed faculty. Dive into our blend of live sessions and hands-on projects designed to demystify HR management. Enroll now to hone your skills and advance your career in the dynamic field of Human Resources!`,
    overview: [
  ...
  },
  {
    id: 11,
    title: "UI/UX Design",
    desc: `"Unlock the Power of UI/UX: Elevate Your Digital Interactions! UI/UX, shorthand for User Interface and User Experience, lies at the core of our digital interactions. While Ul centers. on visual components, buttons, and user interaction processes, UX delves deeper into the holistic user experience, encompassing usability, accessibility, and emotional resonance with the design. Embark on an immersive journey in our UI/UX course, where theory seamlessly integrates with hands-on practice. Explore the art of wireframing, prototyping, and usability testing, enhancing your proficiency in crafting user-centric solutions.
Join us on this enriching adventure to amplify your skills in UI/UX design and unlock new possibilities in the digital landscape. Elevate your digital interactions and make a lasting impact with our comprehensive UI/UX course!"`,
    overview: [
    ...
    curriculum: [
      {
        ...
        desc: ["Primary Research", `Secondary Research`],
      },
      {
        weekTitle: `Week 2`,
        desc: [
      ...
      {
        weekTitle: "Week 5",
        desc: [`Figma Tool explanation and practice`],
      },
      {
        weekTitle: "Week 6",
        desc: [`Assignments Explanation`],
      },
      {
        weekTitle: "Week 7",
        desc: [`Assignments Review`, `Clarification`],
      },
      {
        weekTitle: "Week 8",
        desc: [`Mini Project`, `Design Principles`],
      },
      {
        weekTitle: "Week 9",
        desc: [`Assistance main project review`],
      },
      {
        weekTitle: "Week 10",
        desc: [`Assistance main project review`],
      ...
      {
        weekTitle: "Week 11",
        desc: [`Interview Questions`, `Project Presentation`],
      },
      {
        weekTitle: "Week 12",
        desc: [
          ...
          `Buttons`,
          `Material Design`,
          `Pyschology principles and UI design principles`,
